      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-700/50 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 shrink-0">
        ...
        <div className="flex items-center gap-3">
          {chars.length > 0 && (
            <button
              onClick={generateAll}
              disabled={isGeneratingAll || generatingIdx !== null}
              className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white text-sm font-black transition-all border border-indigo-500/60 shadow-[0_0_12px_rgba(99,102,241,0.3)]"
            >
              {isGeneratingAll ? (
