    ...
    <header className="border-b border-white/[0.07] bg-black/80 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-gradient-to-br from-red-500 to-rose-600 rounded-lg flex items-center justify-center shadow-[0_0_16px_rgba(239,68,68,0.4)]">
          ...
          <span className="text-xl font-black text-white tracking-tight">
            Heaven <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-rose-500">AI</span>
          </span>
        </div>
