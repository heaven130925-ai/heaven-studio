...
export const VISUAL_STYLES = [
  { id: 'custom',            name: '커스텀',          emoji: '✏️', bg: 'from-slate-700 to-slate-800',   img: 'https://source.unsplash.com/300x200/?pencil,sketch,drawing&sig=201',              prompt: '' },
  { id: 'cinematic',         name: '시네마틱 실사',   emoji: '🎬', bg: 'from-slate-700 to-slate-900',   img: 'https://source.unsplash.com/300x200/?cinematic,film,dramatic,movie&sig=101',      prompt: 'Cinematic photorealistic style, Hollywood blockbuster film aesthetic, professional cinematography, dramatic volumetric lighting, shallow depth of field, 8K ultra-detailed, rich cinematic color grading' },
  { id: 'kdrama',            name: 'K-드라마 실사',   emoji: '🌸', bg: 'from-pink-800 to-rose-900',     img: 'https://source.unsplash.com/300x200/?korea,romance,couple,cherry-blossom&sig=102', prompt: 'Korean drama photorealistic style, soft romantic lighting, clean modern Korean aesthetics, beautiful actors with natural makeup, elegant drama set design, warm golden hour lighting, Netflix Korean drama quality' },
  { id: 'noir',              name: '누아르',          emoji: '🌑', bg: 'from-gray-800 to-black',         img: 'https://source.unsplash.com/300x200/?noir,rain,shadow,dark,monochrome&sig=103',   prompt: 'Film noir style, dramatic black and white with deep moody shadows, 1940s detective noir aesthetic, high contrast chiaroscuro lighting, rain-soaked atmospheric streets, expressionist shadows and silhouettes' },
  { id: 'webtoon',           name: '웹툰',            emoji: '📱', bg: 'from-blue-800 to-indigo-900',   img: 'https://source.unsplash.com/300x200/?illustration,colorful,cartoon,digital-art&sig=104', prompt: 'Korean webtoon digital illustration style, clean bold black outlines, vibrant cel-shaded flat coloring, expressive characters, modern manhwa aesthetic, bright high contrast composition' },
  { id: 'comic-webtoon',     name: '만화웹툰',        emoji: '💥', bg: 'from-orange-800 to-red-900',    img: 'https://source.unsplash.com/300x200/?comic,manga,cartoon,superhero&sig=105',       prompt: 'Comic manga webtoon style, bold dynamic thick outlines, exaggerated expressive faces, speed action lines, vibrant saturated colors, halftone texture, manga-influenced Korean comic panel composition' },
  { id: 'retro-comic',       name: '레트로만화',      emoji: '🗞️', bg: 'from-yellow-700 to-orange-900', img: 'https://source.unsplash.com/300x200/?retro,vintage,pop-art,comic&sig=106',         prompt: 'Retro vintage comic book style, 1960s-1970s American comic aesthetic, bold Roy Lichtenstein pop art halftone dots, thick black outlines, primary colors red yellow blue, Ben-Day dots texture, vintage print quality, dramatic speech bubbles' },
  { id: 'japanese-anime',    name: '일본 애니',       emoji: '⛩️', bg: 'from-red-800 to-rose-950',     img: 'https://source.unsplash.com/300x200/?japan,sakura,shrine,anime&sig=107',           prompt: 'Japanese anime illustration style, high-quality anime key visual, vibrant saturated colors, detailed shojo/shonen anime character design, cel-shaded with sharp highlights, expressive large eyes, dynamic anime composition, professional anime studio quality' },
  { id: 'chibi',             name: '치비',            emoji: '🐣', bg: 'from-pink-700 to-fuchsia-900',  img: 'https://source.unsplash.com/300x200/?cute,kawaii,pastel,toy&sig=108',              prompt: 'Cute chibi super-deformed character style, extremely adorable tiny proportions, oversized expressive head, small rounded body, pastel kawaii colors, sparkling anime eyes, soft glossy shading, ultra-cute kawaii aesthetic' },
  { id: 'cyberpunk',         name: '사이버펑크',      emoji: '🤖', bg: 'from-violet-900 to-cyan-950',   img: 'https://source.unsplash.com/300x200/?neon,cyberpunk,night-city,futuristic&sig=109', prompt: 'Cyberpunk dystopian illustration style, neon-lit rain-soaked city streets, glowing neon signs in purple cyan magenta, dark gritty urban future, holographic interfaces, chrome cybernetic implants, blade runner aesthetic, ultra-detailed sci-fi cityscape' },
  { id: 'eastern-fantasy',   name: '동양 판타지',     emoji: '🐉', bg: 'from-red-900 to-amber-950',     img: 'https://source.unsplash.com/300x200/?china,temple,dragon,fantasy,mist&sig=110',    prompt: 'East Asian fantasy xianxia wuxia illustration style, Chinese fantasy aesthetic, flowing robes and ribbons in wind, divine immortal cultivator characters, misty mountain peaks, traditional architecture, jade and gold color palette, dramatic qi energy aura effects, donghua animation quality' },
  { id: 'western-fantasy',   name: '서양 판타지',     emoji: '🧙', bg: 'from-indigo-900 to-blue-950',   img: 'https://source.unsplash.com/300x200/?fantasy,castle,magic,dragon,medieval&sig=111', prompt: 'Western high fantasy illustration style, epic D&D fantasy art aesthetic, dramatic magical lighting, knights paladins elves wizards dragons, enchanted forest and castle ruins, rich jewel tone colors, glowing spell effects, detailed fantasy concept art quality' },
  { id: 'eastern-3d-disney', name: '동양 3D디즈니',  emoji: '🏮', bg: 'from-red-800 to-orange-950',    img: 'https://source.unsplash.com/300x200/?china,lantern,temple,colorful,asia&sig=112',   prompt: 'East Asian 3D Disney Pixar animation style, Chinese Japanese inspired fantasy world, Mulan Moana quality 3D rendering, expressive stylized 3D characters with Asian features, rich red gold teal color palette, traditional architecture in 3D, studio quality Disney lighting and render' },
  { id: 'western-3d-disney', name: '서양 3D디즈니',  emoji: '🏰', bg: 'from-blue-800 to-purple-950',   img: 'https://source.unsplash.com/300x200/?castle,disney,fairy-tale,magical,princess&sig=113', prompt: 'Western 3D Disney Pixar animation style, Frozen Tangled Encanto quality 3D CGI, expressive stylized characters, magical European fantasy setting, rich vibrant color palette, subsurface scattering skin render, Disney studio quality lighting, enchanted castle and forest' },
  { id: 'minecraft',         name: '마인크래프트',    emoji: '⛏️', bg: 'from-green-700 to-lime-900',    img: 'https://source.unsplash.com/300x200/?pixel,blocks,game,voxel,colorful&sig=114',    prompt: 'Minecraft video game pixel art voxel style, blocky cubic 3D world, pixelated low-res textures, green grass blocks brown dirt stone blocks, 16-bit color palette, isometric voxel art perspective, Minecraft game screenshot aesthetic' },
  { id: 'rough-3d',          name: '러프 3D',         emoji: '🎲', bg: 'from-zinc-700 to-neutral-900',  img: 'https://source.unsplash.com/300x200/?clay,sculpture,art,render,3d&sig=115',        prompt: 'Rough stylized 3D illustration style, intentionally loose imperfect 3D render, painterly textured surfaces, expressive gestural marks visible in 3D, warm sketch-like quality, indie animation aesthetic, rough clay render with artistic imperfections' },
  { id: 'xray-anatomy',      name: '투시 인체',       emoji: '🦴', bg: 'from-teal-800 to-cyan-950',     img: 'https://source.unsplash.com/300x200/?xray,skeleton,anatomy,medical&sig=116',       prompt: 'Medical anatomy X-ray cross-section illustration style, transparent body with visible skeleton muscles organs, scientific educational diagram aesthetic, blue-tinted X-ray glow, detailed anatomical accuracy, medical textbook illustration quality' },
  { id: 'skeleton',          name: '해골',            emoji: '💀', bg: 'from-stone-700 to-gray-950',    img: 'https://source.unsplash.com/300x200/?skull,gothic,dark,bones&sig=117',             prompt: 'Gothic skeleton skull illustration style, highly detailed bone anatomy, dramatic dark background, Halloween gothic aesthetic, carved ivory texture on bones, baroque decorative skull motifs, macabre elegant memento mori composition' },
  { id: 'horror',            name: '호러',            emoji: '👻', bg: 'from-red-950 to-black',          img: 'https://source.unsplash.com/300x200/?horror,dark,spooky,ghost&sig=118',           prompt: 'Horror illustration style, deeply unsettling dark atmosphere, grotesque creature design, blood red shadows, psychological horror aesthetic, pale ghostly figures, sharp teeth claws, dark visceral imagery, disturbing surrealist horror composition' },
  { id: 'stickwoman',        name: '스틱우먼',        emoji: '🚺', bg: 'from-pink-800 to-slate-900',    img: 'https://source.unsplash.com/300x200/?minimal,white,simple,drawing&sig=119',        prompt: 'Simple stick figure illustration style with female character details, minimalist line drawing on white background, stick figure woman with simple dress or skirt indicated by triangle shape, clean black marker lines, whiteboard animation style, xkcd-inspired minimal art' },
  { id: '3d-animation',      name: '3D 애니메이션',   emoji: '✨', bg: 'from-cyan-800 to-blue-900',     img: 'https://source.unsplash.com/300x200/?animation,colorful,cartoon,3d-render&sig=120', prompt: 'Pixar Disney quality 3D CGI animation style, smooth subsurface scattering render, expressive stylized 3D characters, vibrant rich colors, cinematic 3D studio lighting, Pixar movie aesthetic' },
  { id: 'claymation',        name: '클레이 애니',     emoji: '🧸', bg: 'from-amber-700 to-yellow-900',  img: 'https://source.unsplash.com/300x200/?clay,puppet,craft,colorful&sig=121',           prompt: 'Claymation stop-motion style, textured plasticine clay figures, handcrafted Aardman aesthetic, visible clay finger texture, warm cozy tones, tactile handmade quality, Shaun the Sheep style' },
  { id: 'fairy-tale',        name: '동화 일러스트',   emoji: '🧚', bg: 'from-purple-800 to-pink-900',   img: 'https://source.unsplash.com/300x200/?fairy-tale,magic,forest,whimsical&sig=122',   prompt: "Whimsical fairy tale children's picture book illustration, soft watercolor gouache technique, pastel dreamy color palette, gentle rounded organic shapes, magical glowing atmosphere, storybook quality" },
  { id: 'wool-doll',         name: '동화 양모인형',   emoji: '🪆', bg: 'from-rose-700 to-fuchsia-900',  img: 'https://source.unsplash.com/300x200/?felt,doll,handmade,craft,wool&sig=123',        prompt: 'Wool felt doll fairy tale style, handmade textile art aesthetic, needle felt puppet with visible soft fiber texture, cozy warm tones, artisan handcraft quality, miniature woolly characters' },
  { id: 'diorama',           name: '디오라마',        emoji: '🏠', bg: 'from-green-800 to-teal-900',    img: 'https://source.unsplash.com/300x200/?miniature,diorama,tiny,model&sig=124',        prompt: 'Miniature diorama tabletop style, tiny handcrafted scale model world, tilt-shift photography blur effect, warm studio lighting on miniatures, detailed scale buildings and props, toy-like railway model aesthetic' },
  { id: 'historical',        name: '사극 일러스트',   emoji: '⚔️', bg: 'from-amber-900 to-stone-900',  img: 'https://source.unsplash.com/300x200/?korea,hanbok,traditional,palace&sig=125',      prompt: 'Korean historical drama illustration style, Joseon dynasty period aesthetic, traditional Korean Hanbok costumes and architecture, classical East Asian ink painting influence, elegant brushwork, rich jewel tones with gold accents' },
  { id: 'webnovel',          name: '웹소설 시그니쳐', emoji: '📖', bg: 'from-violet-800 to-purple-900', img: 'https://source.unsplash.com/300x200/?fantasy,dramatic,portrait,glowing&sig=126',   prompt: 'Korean web novel signature cover illustration style, dramatic fantasy character portrait, flowing hair and clothing in dynamic wind, intense gaze, glowing magical light effects, rich saturated fantasy colors' },
  { id: 'ghibli',            name: '지브리풍',        emoji: '🌿', bg: 'from-emerald-600 to-green-800', img: 'https://source.unsplash.com/300x200/?nature,green,forest,lush,japan&sig=127',     prompt: 'Studio Ghibli authentic animation style, Hayao Miyazaki masterpiece quality, richly saturated lush watercolor backgrounds with incredible organic detail, vivid emerald greens deep sky blues warm sunset oranges, expressive hand-drawn characters, magical realism with tangible weight, complex layered backgrounds, Studio Ghibli film cel quality, spirited away princess mononoke howls moving castle aesthetic' },
  { id: 'stickman',          name: '스틱맨',          emoji: '🖊️', bg: 'from-slate-600 to-slate-800',  img: 'https://source.unsplash.com/300x200/?minimal,white,simple,sketch&sig=128',          prompt: 'Simple stick figure illustration style, clean minimalist black line drawings on white background, xkcd-style stick figure characters, simple geometric shapes, hand-drawn marker whiteboard animation aesthetic' },
] as const;
