...
export const VISUAL_STYLES = [
  ...
  { id: 'webtoon',           name: '웹툰',            emoji: '📱', bg: 'from-blue-800 to-indigo-900',   img: '',                                    prompt: 'Korean webtoon digital illustration style, clean bold black outlines, vibrant cel-shaded flat coloring, expressive characters, modern manhwa aesthetic, bright high contrast composition' },
  ...
  { id: 'stickwoman',        name: '스틱우먼',        emoji: '🚺', bg: 'from-pink-800 to-slate-900',    img: '/style-previews/stickwoman.jpg',      prompt: 'Simple stick figure illustration style with female character details, minimalist line drawing on white background, stick figure woman with simple dress or skirt indicated by triangle shape, clean black marker lines, whiteboard animation style, xkcd-inspired minimal art' },
  { id: 'stickman',          name: '스틱맨',          emoji: '🖊️', bg: 'from-slate-600 to-slate-800',  img: '/style-previews/stickman.jpg',        prompt: 'Simple stick figure illustration style, clean minimalist black line drawings on white background, xkcd-style stick figure characters, simple geometric shapes, hand-drawn marker whiteboard animation aesthetic' },
  ...
  { id: 'claymation',        name: '클레이 애니',     emoji: '🧸', bg: 'from-amber-700 to-yellow-900',  img: '',                                    prompt: 'Claymation stop-motion style, textured plasticine clay figures, handcrafted Aardman aesthetic, visible clay finger texture, warm cozy tones, tactile handmade quality, Shaun the Sheep style' },
  ...
  { id: 'wool-doll',         name: '동화 양모인형',   emoji: '🪆', bg: 'from-rose-700 to-fuchsia-900',  img: '',                                    prompt: 'Wool felt doll fairy tale style, handmade textile art aesthetic, needle felt puppet with visible soft fiber texture, cozy warm tones, artisan handcraft quality, miniature woolly characters' },
