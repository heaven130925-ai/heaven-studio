...
export const VISUAL_STYLES = [
  ...
  { id: 'retro-comic',    name: '레트로만화',      emoji: '🗞️', bg: 'from-yellow-700 to-orange-900',  prompt: 'Retro vintage comic book style, 1960s-1970s American comic aesthetic, bold Roy Lichtenstein pop art halftone dots, thick black outlines, primary colors red yellow blue, Ben-Day dots texture, vintage print quality, dramatic speech bubbles' },
  { id: 'japanese-anime', name: '일본 애니',       emoji: '⛩️', bg: 'from-red-800 to-rose-950',      prompt: 'Japanese anime illustration style, high-quality anime key visual, vibrant saturated colors, detailed shojo/shonen anime character design, cel-shaded with sharp highlights, expressive large eyes, dynamic anime composition, professional anime studio quality' },
  { id: 'chibi',          name: '치비',            emoji: '🐣', bg: 'from-pink-700 to-fuchsia-900',   prompt: 'Cute chibi super-deformed character style, extremely adorable tiny proportions, oversized expressive head, small rounded body, pastel kawaii colors, sparkling anime eyes, soft glossy shading, ultra-cute kawaii aesthetic' },
  { id: 'cyberpunk',      name: '사이버펑크',      emoji: '🤖', bg: 'from-violet-900 to-cyan-950',    prompt: 'Cyberpunk dystopian illustration style, neon-lit rain-soaked city streets, glowing neon signs in purple cyan magenta, dark gritty urban future, holographic interfaces, chrome cybernetic implants, blade runner aesthetic, ultra-detailed sci-fi cityscape' },
  { id: 'eastern-fantasy',name: '동양 판타지',     emoji: '🐉', bg: 'from-red-900 to-amber-950',      prompt: 'East Asian fantasy xianxia wuxia illustration style, Chinese fantasy aesthetic, flowing robes and ribbons in wind, divine immortal cultivator characters, misty mountain peaks, traditional architecture, jade and gold color palette, dramatic qi energy aura effects, donghua animation quality' },
  { id: 'western-fantasy',name: '서양 판타지',     emoji: '🧙', bg: 'from-indigo-900 to-blue-950',    prompt: 'Western high fantasy illustration style, epic D&D fantasy art aesthetic, dramatic magical lighting, knights paladins elves wizards dragons, enchanted forest and castle ruins, rich jewel tone colors, glowing spell effects, detailed fantasy concept art quality' },
  { id: 'eastern-3d-disney', name: '동양 3D디즈니',emoji: '🏮', bg: 'from-red-800 to-orange-950',    prompt: 'East Asian 3D Disney Pixar animation style, Chinese Japanese inspired fantasy world, Mulan Moana quality 3D rendering, expressive stylized 3D characters with Asian features, rich red gold teal color palette, traditional architecture in 3D, studio quality Disney lighting and render' },
  { id: 'western-3d-disney', name: '서양 3D디즈니',emoji: '🏰', bg: 'from-blue-800 to-purple-950',   prompt: 'Western 3D Disney Pixar animation style, Frozen Tangled Encanto quality 3D CGI, expressive stylized characters, magical European fantasy setting, rich vibrant color palette, subsurface scattering skin render, Disney studio quality lighting, enchanted castle and forest' },
  { id: 'minecraft',      name: '마인크래프트',    emoji: '⛏️', bg: 'from-green-700 to-lime-900',     prompt: 'Minecraft video game pixel art voxel style, blocky cubic 3D world, pixelated low-res textures, green grass blocks brown dirt stone blocks, 16-bit color palette, isometric voxel art perspective, Minecraft game screenshot aesthetic' },
  { id: 'rough-3d',       name: '러프 3D',         emoji: '🎲', bg: 'from-zinc-700 to-neutral-900',   prompt: 'Rough stylized 3D illustration style, intentionally loose imperfect 3D render, painterly textured surfaces, expressive gestural marks visible in 3D, warm sketch-like quality, indie animation aesthetic, rough clay render with artistic imperfections' },
  { id: 'xray-anatomy',   name: '투시 인체',       emoji: '🦴', bg: 'from-teal-800 to-cyan-950',      prompt: 'Medical anatomy X-ray cross-section illustration style, transparent body with visible skeleton muscles organs, scientific educational diagram aesthetic, blue-tinted X-ray glow, detailed anatomical accuracy, medical textbook illustration quality' },
  { id: 'skeleton',       name: '해골',            emoji: '💀', bg: 'from-stone-700 to-gray-950',      prompt: 'Gothic skeleton skull illustration style, highly detailed bone anatomy, dramatic dark background, Halloween gothic aesthetic, carved ivory texture on bones, baroque decorative skull motifs, macabre elegant memento mori composition' },
  { id: 'horror',         name: '호러',            emoji: '👻', bg: 'from-red-950 to-black',           prompt: 'Horror illustration style, deeply unsettling dark atmosphere, grotesque creature design, blood red shadows, psychological horror aesthetic, pale ghostly figures, sharp teeth claws, dark visceral imagery, disturbing surrealist horror composition' },
  { id: 'stickwoman',     name: '스틱우먼',        emoji: '🚺', bg: 'from-pink-800 to-slate-900',      prompt: 'Simple stick figure illustration style with female character details, minimalist line drawing on white background, stick figure woman with simple dress or skirt indicated by triangle shape, clean black marker lines, whiteboard animation style, xkcd-inspired minimal art' },
